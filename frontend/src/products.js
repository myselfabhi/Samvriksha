...
export const products = [
    ...
    },
    {
        "id": 7,
        "name": "Samjyoti Lamp",
        "description": "A collection of exquisite lamps showcasing real preserved flowers and moss, radiating a soft, natural glow and propagating positivity. Each lamp is entirely sustainable and free from plastic, blending elegance with eco-conscious craftsmanship.",
        "category": ["gift", "decor"],
        "type": ["indoor"],
        "img": ["/samjyotiLamp.PNG", "/samjyotiLamp2.PNG", "/samjyotiLamp3.PNG", "/samjyotiLamp4.PNG", "/ishwarLamp.PNG", "/ishwarLamp2.PNG"],
        "slug": "samjyoti-lamp",
        "variants": [
            {
                "name": "Nature Moss Stand Lamp",
                "sizes": [
                    { "size": "6 inch", "price": 2199 },
                    { "size": "8 inch", "price": 2599 }
                ],
                "colors": [],
                "designs": []
            },
            {
                "name": "Divine Moss Stand Lamp",
                "sizes": [
                    { "size": "7 inch", "price": 2499 }
                ],
                "colors": [],
                "designs": ["Shiva", "Ganesha", "Hanuman", "Budha"]
            },
            {
                "name": "Portable Wireless Lamp",
                "sizes": [
                    { "size": "Nature Only", "price": 2499 }
                ],
                "colors": [],
                "designs": []
            }
        ...
        "variants": [
            {
                "name": "Moss Variant",
                "sizes": [
                    { "size": "18 inch", "price": 2499 },
                    { "size": "24 inch", "price": 4499 }
                ],
                "colors": [],
                "designs": []
            },
            {
                "name": "Forest Variant",
                "sizes": [
                    { "size": "18 inch", "price": 3199 },
                    { "size": "24 inch", "price": 5199 }
                ],
                "colors": [],
                "designs": []
            },
            {
                "name": "Night Glow Variant",
                "sizes": [
                    { "size": "18 inch", "price": 3899 },
                    { "size": "24 inch", "price": 5899 }
                ],
                "additionalOptions": [
                    { "name": "Rechargeable Magnetic Battery", "price": 1000 }
                ],
                "colors": [],
                "designs": []
            }
    ...
    },
    {
        "id": 10,
        "name": "Prakriti Glow",
        "description": "Prakriti Glow combines nature and functionality, featuring live plants arranged vertically at the sides for a vibrant, eco-friendly touch. It includes a lamp crafted with real preserved flowers encased in a bamboo lid and glass jar, emitting a warm glow, and a tempered glass shelf designed to hold decor or utility items. Available in spotlight and striplight variants.",
        "category": ["decor"],
        "type": ["indoor"],
        "img": ["/prakritiSpotlight.PNG", "/prakritiStriplight.PNG"],
        "slug": "prakriti-glow",
        "variants": [
            {
                "name": "Spotlight",
                "sizes": [
                    { "size": "default", "price": 4999 }
                ],
                "colors": ["white"],
                "designs": []
            },
    ...
    },
    {
        ...
        "variants": [
            {
                "name": "Circular Design 1",
                "sizes": [
                    { "size": "with LED", "price": 3499 },
                    { "size": "without LED", "price": 2499 }
                ],
                "colors": [],
                "designs": []
            },
            {
                "name": "Circular Design 2",
                "sizes": [
                    { "size": "with LED", "price": 3499 },
                    { "size": "without LED", "price": 2499 }
                ],
    ...
    },
    {
        ...
        "description": "A divine collection of lamps featuring intricate designs and customizable LED colors. Each lamp is crafted with care, blending spirituality and nature. Optional rechargeable magnetic battery available for an additional cost.",
        "category": ["decor", "spiritual"],
        "type": ["indoor"],
        "img": ["/divineBlessing1.png"],
        "slug": "divine-blessing",
        "variants": [
            {
                "name": "Shiva - Rainforest",
                "sizes": [
                    {
                        "size": "18 inch",
                        "price": 5499
                ...
                "colors": ["white", "yellow", "ice blue", "green"],
                "additionalOptions": [
                    { "name": "Rechargeable Magnetic Battery", "price": 1000 }
                ]
            },
